...
//                print("changeRequest?.displayName = \(changeRequest?.displayName)")
    ...
    //MARK: Get deals when user name is changed:
...
//                           let image = data["ImagePath"] as? String,
                           ...
                           let date = data["Date"] as? Double {
                            ...
                            if Date().timeIntervalSince1970 - date < 86400 {
                                self.getDeals(dealTitle: dealTitle, dealDesc: dealDesc, storeTitle: storeTitle, storeID: storeID, dealID: dealID, sender: sender, userName: userName, distance: distance, senderUID: senderUID, countDown: difference)
...
//                        if let error = error {
//                            print("error removing deal image: \(error)")
//                            return
//                        } else {
...
//                    }
    ...
    //MARK: - Get Profile's Deals from Firebase
    func getDeals(dealTitle: String, dealDesc: String, storeTitle: String, storeID: String, dealID: String, sender: String, userName: String, distance: Double, senderUID: String, countDown: Int) {
        ...
        self.deals.userDeals.append(DealModel(storeID: storeID, dealImage: UIImage(named: "user-deal"), dealTitle: dealTitle, dealDesc: dealDesc, dealID: dealID, storeTitle: storeTitle, sender: sender, userName: userName, distance: distance, senderUID: senderUID, countDown: countDown))
